				...
				<div className="max-w-6xl mx-auto">
					...
					<div className="grid md:grid-cols-3 gap-6 mb-12">
						<FadeInOnScroll delay={0}>
							<div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition h-full">
								<div className="bg-blue-50 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
									<Image src={voteImg} alt="투표" width={24} height={24} />
								</div>
						...
						<FadeInOnScroll delay={100}>
							<div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition h-full">
								<div className="bg-blue-50 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
									<Image src={graphImg} alt="그래프" width={24} height={24} />
								</div>
						...
						<FadeInOnScroll delay={200}>
							<div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition h-full">
								<div className="bg-blue-50 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
									<Image src={chatImg} alt="채팅" width={24} height={24} />
								</div>
					...
					<div className="grid md:grid-cols-3 gap-6">
						<FadeInOnScroll delay={0}>
							<div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition h-full">
								<div className="bg-blue-50 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
									<Image src={peopleImg} alt="사람들" width={24} height={24} />
								</div>
						...
						<FadeInOnScroll delay={100}>
							<div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition h-full">
								<div className="bg-blue-50 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
									<Image src={electricImg} alt="번개" width={24} height={24} />
								</div>
						...
						<FadeInOnScroll delay={200}>
							<div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition h-full">
								<div className="bg-blue-50 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
									<Image src={guardImg} alt="보안" width={24} height={24} />
								</div>
